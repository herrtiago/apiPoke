...
<template>
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <a class="flex justify-center items-center pt-8 sm:pt-0" href="https://coex.com.co/" target="_blank">
      <img class="w-25 h-20" src="/logoCoex.png" alt=""> <h1 class="text-2xl leading-7 font-semibold">COEX</h1></a>
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">
          Welcome to your Nuxt Application aaaaaaaaaaaaaaaaaaaa
        </h2>
